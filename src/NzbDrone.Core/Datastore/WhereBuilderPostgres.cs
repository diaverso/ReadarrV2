    ...
    public class WhereBuilderPostgres : WhereBuilder
    {
        ...
        protected override Expression VisitMethodCall(MethodCallExpression expression)
        {
            ...
            switch (expression.Method.Name)
            {
                ...
                case "op_Implicit":
                case "op_Explicit":
                    // Conversion operators - visit the underlying value directly
        ...
        private void ParseEnumerableContains(MethodCallExpression body)
        {
            ...
            {
                // Static method (e.g. Enumerable.Contains or compiler-generated array Contains in .NET 10+)
                if (body.Arguments.Count < 2)
                {
                    throw new NotSupportedException(
                        $"Unexpected form of Enumerable.Contains: DeclaringType={body.Method.DeclaringType?.FullName}, ArgCount={body.Arguments.Count}");
                }
