...
> **Estado / Status:** Este es un fork comunitario activo. El equipo original de Servarr retiró el proyecto, pero la comunidad ha restaurado la funcionalidad de metadatos y continúa el desarrollo.
>
> **This is an active community fork.** The original Servarr team retired the project, but the community has restored metadata functionality and continues development.

---

**Documentación / Documentation:**
- [Documentación en Español](docs/es/LEEME.md)
- [Documentation in English](docs/en/README.md)

---

<details>
<summary>📢 Original retirement announcement (Servarr Team)</summary>
...
## ✅ What's working in this fork

### Metadata
- **Metadata restored** via [rreading-glasses](https://github.com/blampe/rreading-glasses) (`api.bookinfo.pro`) — works out of the box, no configuration needed
...
- Filenames capped at 255 bytes to prevent filesystem errors on Windows/Linux (#3996)
- `Object.groupBy` polyfill added for Firefox ESR 115 — calendar no longer breaks (#3948)
- KEPUB added as Calibre conversion output format (Calibre 8.0+) (#4099)
- Background author refresh no longer triggers unnecessary UI reloads (#4091)

### UI modernization
- Sidebar active indicator uses indigo accent color for visual cohesion
- Author and Book detail headers: gradient backdrop (cover art shows through at top)
- Book detail page title: `text-wrap: balance`, tighter tracking — matches author page
- Book index poster cards: smooth lift + shadow hover effect matching author cards
- Table rows: 42px min-height, snappier hover transitions
- Inter font with proper `font-feature-settings` (ligatures + kerning)

See the full [Changelog (EN)](docs/en/changelog.md) / [Registro de Cambios (ES)](docs/es/registro-de-cambios.md).
...
- [Architecture & Dev Setup (English)](docs/en/development-setup.md)
- [Arquitectura y Desarrollo (Español)](docs/es/configuracion-desarrollo.md)
